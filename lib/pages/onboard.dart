    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        children: [
          ...
          Container(
            decoration:
                BoxDecoration(color: CapyColors.secondary.withOpacity(.2)),
          ),
          Padding(
