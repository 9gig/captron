import 'package:captron/config/asset_config/assets.gen.dart';
...
class Captron extends StatelessWidget {
  ...
  buildCreate(BuildContext context) {
    buildOption({required String text, required Widget icon}) {
      return InkWell(
        onTap: () {
          context.push('/getCaptions');
        },
        child: Container(
          height: 88.h,
          width: 158.w,
          decoration: BoxDecoration(
              border: Border.all(color: CapyColors.primary, width: 1),
